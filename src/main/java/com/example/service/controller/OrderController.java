...
public class OrderController {
    ...
    public OrderController() {
        ...
        Order order1 = new Order("1", "Order A", "123456789", 0, "Area A", "Pending", 10, new ArrayList<>());
        order1.getProductList().add(new Product("1", "Product A", 100, "Shop A","url"));
        order1.getProductList().add(new Product("1", "Product A", 100, "Shop A","url"));

        Order order2 = new Order("2", "Order B", "987654321", 0, "Area B", "Shipped", 20, new ArrayList<>());
        order2.getProductList().add(new Product("1", "Product A", 100, "Shop A","url"));
